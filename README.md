...
Release-Tags folgen `erpverein-v<erpnext-version>-<app-version>`, fuer diesen Stand zum Beispiel `erpverein-v16.26.2-0.1.3`. Das Image wird als `ghcr.io/<owner>/erpverein:<tag>` veroeffentlicht.
