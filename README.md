...
Release-Tags folgen `erpverein-v<erpnext-version>-<app-version>`, fuer diesen Stand `erpverein-v16.28.0-0.1.8`. Das Image wird als `ghcr.io/<owner>/erpverein:<tag>` veroeffentlicht.
