...
from erpverein.services.subscription_generation_service import RUN_INPUT_FIELDS, set_subscription_run_defaults, validate_membership_periods


class Beitragsabrechnung(Document):
    ...
    def validate(self) -> None:
        set_subscription_run_defaults(self)
        validate_membership_periods(self)
